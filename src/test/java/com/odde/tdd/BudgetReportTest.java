...
public class BudgetReportTest {
    ...
    public void no_budget() {
        givenBudgets();
        assertEquals(0, report.totalBudget(LocalDate.parse("2018-12-01"), LocalDate.parse("2018-12-20")));
    }

    @Test
    public void query_whole_budget(){
        givenBudgets(new Budget(YearMonth.of(2018, 1), 3100));
        assertEquals(3100, report.totalBudget(LocalDate.parse("2018-01-01"), LocalDate.parse("2018-01-31")));
    }

    @Test
    public void query_within_one_budget(){
        givenBudgets(new Budget(YearMonth.of(2018, 12), 3100));
        assertEquals(2000, report.totalBudget(LocalDate.parse("2018-12-01"), LocalDate.parse("2018-12-20")));
    }

    @Test
    public void query_before_budget() {
        givenBudgets(new Budget(YearMonth.of(2018, 12), 3100));
        assertEquals(1000, report.totalBudget(LocalDate.parse("2018-11-25"), LocalDate.parse("2018-12-10")));
    }

    @Test
    public void query_after_budget() {
        givenBudgets(new Budget(YearMonth.of(2018, 12), 3100));
        assertEquals(700, report.totalBudget(LocalDate.parse("2018-12-25"), LocalDate.parse("2019-01-10")));
    }

    @Test
    public void query_out_of_budget() {
        givenBudgets(new Budget(YearMonth.of(2018, 12), 3100));
        assertEquals(0, report.totalBudget(LocalDate.parse("2019-01-05"), LocalDate.parse("2019-01-10")));
    }
    ...
    public void query_across_years() {
        ...
        assertEquals(2700+3100+3100+1000, report.totalBudget(LocalDate.parse("2017-12-05"), LocalDate.parse("2019-01-10")));
    }
    ...
    public void query_multiple_budgets(){
        ...
        assertEquals(1700 + 2800 + 3100 + 600, report.totalBudget(LocalDate.parse("2018-01-15"), LocalDate.parse("2018-05-06")));
    }
